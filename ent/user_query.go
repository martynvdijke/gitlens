...
func (_q *UserQuery) QueryRepositories() *RepositoryQuery {
...
func (_q *UserQuery) WithRepositories(opts ...func(*RepositoryQuery)) *UserQuery {
	query := (&RepositoryClient{config: _q.config}).Query()
...
func (_q *UserQuery) loadRepositories(ctx context.Context, query *RepositoryQuery, nodes []*User, init func(*User), assign func(*User, *Repository)) error {
