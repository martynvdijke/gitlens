...
func (_q *RepositoryQuery) QueryUser() *UserQuery {
...
func (_q *RepositoryQuery) WithUser(opts ...func(*UserQuery)) *RepositoryQuery {
	query := (&UserClient{config: _q.config}).Query()
...
func (_q *RepositoryQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Repository, error) {
	...
	if query := _q.withUser; query != nil {
		if err := _q.loadUser(ctx, query, nodes, nil,
			func(n *Repository, e *User) { n.Edges.User = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *RepositoryQuery) loadUser(ctx context.Context, query *UserQuery, nodes []*Repository, init func(*Repository), assign func(*Repository, *User)) error {
